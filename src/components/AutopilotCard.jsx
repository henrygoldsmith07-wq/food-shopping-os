      ...
      <Card className="!p-4" style={{ borderColor: primary.priority === 'high' ? 'var(--accent)' : 'var(--line)' }}>
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            {primary.caution && (
              <p className="mt-1 text-[0.6875rem] font-bold" style={{ color: 'var(--warn, var(--muted))' }} role="note">
                {primary.needsConfirmation ? 'Check first — ' : ''}{primary.caution}
              </p>
            )}
            {primary.score > 0 && !primary.caution && <p className="mt-1 text-[0.6875rem] font-bold" style={{ color: 'var(--faint)' }}>Ranked for likely impact and ease of completion.</p>}
